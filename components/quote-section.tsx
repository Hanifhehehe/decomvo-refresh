    ...
    >
      ...
      <div className="reveal-section reveal-hidden reveal-delay-1 relative z-10 mx-auto max-w-5xl">
        ...
        <p className="font-body text-4xl font-light italic leading-[1.1] tracking-tight text-on-surface md:text-7xl">
          &quot;Dekolonisierung ist keine Metapher. Sie ist das Bekenntnis, jene Strukturen aufzubrechen, die marginalisierte Geschichten zum Schweigen bringen, und sich eine Zukunft vorzustellen, die auf Gerechtigkeit und Gemeinschaft aufgebaut ist.&quot;
        </p>
